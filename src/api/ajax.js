...
export const ajax1 = (url, data={enterprise: enterprise, enterpriseAdmin: enterpriseAdmin, enterpriseInfo: enterpriseInfo, enterprisePay: enterprisePay}, method='GET', reqConfig) => {
